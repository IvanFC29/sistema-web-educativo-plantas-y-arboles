            ...
            <form  onSubmit={ingresar} className="space-y-6" action="#">
                <div>
                    ...
                    <input type="email" id="email" 
                        ...
                        {errors.email && <span>LLene este campo</span>} 
                </div>
                <div>
                    ...
                    <input type="password" id="password" 
                        ...
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:border-green-500 dark:text-black"  placeholder="••••••••"/>
                        {errors.password && <span>LLene este campo</span>}
                </div>
